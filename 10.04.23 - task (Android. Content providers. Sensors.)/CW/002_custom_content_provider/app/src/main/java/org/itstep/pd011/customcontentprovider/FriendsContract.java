...
// То есть в данном случае провайдер будет называться "org.itstep.pd011.customcontentprovider".
...
public class FriendsContract {
    ...
    static final String CONTENT_AUTHORITY = "org.itstep.pd011.customcontentprovider";
