...
import org.itstep.pd011.listviewdiscover.adapters.SchoolOptimizedAdapter;
...
public class CustomAdapterOptimizedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_custom_adapter_optimized);
        ...
        // 2. Создание адаптера
        SchoolOptimizedAdapter schoolActionAdapter = new SchoolOptimizedAdapter(
                this,
                R.layout.school_item_action,
                schools);

        // 3. Назаначение адаптера
        lsvCustomOptimizedAdapter.setAdapter(schoolActionAdapter);
    }
