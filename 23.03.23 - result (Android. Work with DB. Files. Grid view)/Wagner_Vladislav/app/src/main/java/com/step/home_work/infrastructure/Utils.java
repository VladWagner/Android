...
public class Utils {
    ...
    //Производитель и модель телевизора
    public static final List<SimpleTuple<String, String>> producers = new ArrayList<>(List.of(
            new SimpleTuple<>("LG SIGNATURE OLED R",        "images/LG.jpg"),
            new SimpleTuple<>("LG A2 Smart OLED"   ,        "images/LG.jpg"),
            new SimpleTuple<>("LG G1 4K Smart OLED",        "images/LG.jpg"),
            new SimpleTuple<>("LG C14 4K Smart OLED",       "images/LG.jpg"),
            new SimpleTuple<>("LG B1 4K Smart OLED",        "images/LG.jpg"),
            new SimpleTuple<>("Samsung QLED 4K Q80A",       "images/Samsung.jpg"),
            new SimpleTuple<>("Samsung QN95B",              "images/Samsung.jpg"),
            new SimpleTuple<>("Samsung Neo QLED 8K QN900B", "images/Samsung.jpg"),
            new SimpleTuple<>("Samsung QLED 4K Q60B",       "images/Samsung.jpg")));

    public static SimpleTuple<String, String> getBreed() {
        return producers.get(getRandom(0, producers.size()));
    }


    //Список суден
    public static List<Television> generateTvList(int count) {

        return Stream.generate(Television::factory).limit(count).collect(Collectors.toList());
    }
