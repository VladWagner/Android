...
public class Utils {
    ...
    public static SubscriptionsRepository subscriptionsRepository;
    public static PublicationsRepository publicationsRepository;
    ...
    public static void setComplexSpinner(Context context, Spinner spinner, List<StringWithId> collection, int itemLayoutId, int dropDownLayoutId) {
