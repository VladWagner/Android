...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // регистрация контекстного меню в тех View, которые нужны по заданию
        // допустим, в TextView активности
        registerForContextMenu(txvUser);
        registerForContextMenu(txvBeverige);
    } // onCreate
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        // связать разметку со ссылкой на меню
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.mniUserCreate:
                createUser();
                break;
            case R.id.mniUserProcess:
                startUserActivity();
                break;
            case R.id.mniBeveriedgeCreate:
                createBeveridge();
                break;
            case R.id.mniBeveriedgeProcess:
                startBeveridgeActivity();
                break;
            case R.id.mniExit:
                finish();
    ...
    // !!! регистрация контекстного меню должна выполняться при создании активности !!!
    // связь разметки и ссылки на контекстное меню
    ...
    // обработка пункта контекстного меню
    @Override
    public boolean onContextItemSelected(@NonNull MenuItem item) {
        // обработка выбора в меню по ид пункта
        switch (item.getItemId()) {
            case R.id.cmiUserProcess:
                startUserActivity();
                break;
            case R.id.cmiBeveriedgeProcess:
                startBeveridgeActivity();
                break;
            case R.id.cmiExit:
                finish();
