...
import com.step.wagner.fragments.dialogs.Query1Dialog;
import com.step.wagner.fragments.dialogs.Query2Dialog;
import com.step.wagner.fragments.dialogs.Query3Dialog;
import com.step.wagner.fragments.dialogs.Query4Dialog;
            ...
            case 1:
                ...
                query1Dialog.setListener((String... params) -> {
                    ...
                    dbTaskQuery1.execute(() -> {
                        ...
                        List<Patient> patients = Utils.patientsRepository.query1(params[0] + "%");

                        Utils.patientsRepository.close();

                        String title = patients.size() > 0 ? String.format("выборка пациентов по фамилии начинающейся на %s", params[0])
                                : "ничего не найдено";
